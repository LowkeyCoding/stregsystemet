...
urlpatterns = [
    ...
    re_path(r"^(?P<room_id>\d+)/sale/(?P<username>[^/]+)/$", views.menu_sale, name="menu"),
    re_path(r"^(?P<room_id>\d+)/sale/\d+/\w+/$", lambda request, room_id: redirect("menu_index", room_id=room_id),name="menu_sale",),
    re_path(r"^(?P<room_id>\d+)/user/(?P<username>[^/]+)/$", views.menu_userinfo,name="userinfo",),
    re_path(r"^(?P<room_id>\d+)/user/(?P<username>[^/]+)/pay$", views.menu_userpay, name="userpay",),
