...
urlpatterns = [
    ...
    re_path(r'^(?P<room_id>\d+)/user/$', views.menu_userinfo, name="userinfo"),
    re_path(r'^(?P<room_id>\d+)/user/sale/$', views.menu_sale, name="menu"),
    re_path(r'^(?P<room_id>\d+)/user/pay$', views.menu_userpay, name="userpay"),
